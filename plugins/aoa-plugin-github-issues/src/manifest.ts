...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description:
    "Bidirectional sync between GitHub Issues and AoA issues. Link individual GitHub issues, sync status changes, and optionally bridge comments.",
  ...
  instanceConfigSchema: {
    ...
    properties: {
      ...
      syncDirection: {
        ...
        enum: ["bidirectional", "github-to-aoa", "aoa-to-github"],
  ...
  tools: [
    ...
    },
    {
      ...
      description:
        "Link a GitHub issue to the current AoA issue for bidirectional sync.",
      parametersSchema: {
        type: "object",
        properties: {
          ghIssueUrl: {
