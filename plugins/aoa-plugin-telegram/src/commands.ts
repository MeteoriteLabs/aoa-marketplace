import type { PluginContext, PluginEvent, Agent, Issue, Project } from "@armyofagents/plugin-sdk";
...
export const BOT_COMMANDS: BotCommand[] = [
  ...
  { command: "connect", description: "Link this chat to an AoA company" },
...
async function handleHelp(
  ...
  const lines = [
    escapeMarkdownV2("📎") + " *AoA Bot Commands*",
    "",
    ...BOT_COMMANDS.map(
