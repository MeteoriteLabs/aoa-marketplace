export const PLUGIN_ID = "aoa-plugin-discord";
...
export const ACP_PLUGIN_EVENT_PREFIX = "plugin.aoa-plugin-acp";
export const DISCORD_PLUGIN_EVENT_PREFIX = "plugin.aoa-plugin-discord";
